            ...
            if (moveManager != null)
            {
                switch (moveManager.currentIndex)
                {
                    ...
                    case 1:
                        ...
                        break;
                    case 2:
                        podestText.text = "Ich war mit Übungen meiner Lichtmagie beschäftigt, um endlich die Anerkennung zu bekommen, die mir niemand gewährt. Jemand ist ganz plötzlich an mir vorbei gerauscht und hat mich so aus der Fassung gebracht, dass ich in einen großen Laubhaufen fiel. Da hätte ich beinahe die Kontrolle über meine Magie verloren. Bei dieser Trockenheit hätte ein Funken ausgereicht, um ein Inferno zu verursachen!";
                        break;
                    case 3:
