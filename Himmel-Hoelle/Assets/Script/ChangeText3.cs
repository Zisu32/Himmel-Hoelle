            ...
            if (moveManager != null)
            {
                switch (moveManager.currentIndex)
                {
                    ...
                    case 4:
                        ...
                        break;
                    case 5:
                        podestText.text = "Ich gebe zu, ich bin ein Schelm, aber ich bin kein Mörder! Ihr müsst mir glauben, ich hatte nichts mit dem Tod dieser armen Seele zu tun! Ich hörte allerdings Stimmen im Wald, eine männliche und drei weibliche. Ob es die Täter sind kann ich nicht genau sagen. Zudem hat sich Marcys Nachbar immer ziemlich über ihren Gesang aufgeregt...";
                        break;
                    case 6:
                    ...
                    case 8:
                        ...
                        break;
                    case 9:
                        podestText.text = "Ich mag vielleicht mysteriös wirken, aber ich versichere euch, ich habe nichts mit dem Tod dieser armen Seele zu tun. Außerdem war Marcy meine Nachbarin, die ich über alles respektierte.";
                        break; 
                    default:
